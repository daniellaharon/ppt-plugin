...
describe('Office-Add-Taskpane-Ts projects', () => {
    ...
    describe('Package.json is updated appropriately', () => {
        it('Package.json is updated properly', () => __awaiter(void 0, void 0, void 0, function* () {
            const data = yield readFileAsync(packageJsonFile, 'utf8');
    ...
    describe('Manifest.xml is updated appropriately', () => {
        it('Manifest.xml is updated appropriately', () => __awaiter(void 0, void 0, void 0, function* () {
            const manifestInfo = yield office_addin_manifest_1.OfficeAddinManifest.readManifestFile(manifestFile);
...
//     });
// });
//# sourceMappingURL=convert-to-single-host.js.map