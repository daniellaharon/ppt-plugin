...
const childProcessExec = (0, util_1.promisify)(childProcess.exec);
...
module.exports = class extends yo {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (usageData.needToPromptForUsageData(usageDataOptions.groupName)) {
                    ...
                    const answerForUsageDataPrompt = yield this.prompt(promptForUsageData);
                    if ((answerForUsageDataPrompt === null || answerForUsageDataPrompt === void 0 ? void 0 : answerForUsageDataPrompt.usageDataPromptAnswer) === 'Continue') {
                ...
                jsonData = new projectsJsonData_1.default(this.templatePath());
                ...
                const answerForProjectType = yield this.prompt(askForProjectType);
                ...
                const answerForScriptType = yield this.prompt(askForScriptType);
                ...
                const answerForName = yield this.prompt(askForName);
                ...
                const answerForHost = yield this.prompt(askForHost);
    ...
    _configureProject(answerForProjectType, answerForScriptType, answerForHost, answerForName, isManifestProject, isExcelFunctionsProject) {
        try {
            ...
            this.project = {
                ...
                host: answerForHost.host
                    ...
                    : this.options.host
                        ? this.options.host
                        : jsonData === null || jsonData === void 0 ? void 0 : jsonData.getHostTemplateNames(projType)[0],
                ...
                scriptType: answerForScriptType.scriptType
                    ...
                    : this.options.ts
                        ...
                        : this.options.js
                            ? javascript
                            : jsonData === null || jsonData === void 0 ? void 0 : jsonData.getSupportedScriptTypes(projType)[0],
            ...
            this.project.projectId = (0, uuid_1.v4)();
    ...
    _copyProjectFiles() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const jsonData = new projectsJsonData_1.default(this.templatePath());
                    ...
                    if (projectRepoBranchInfo.repo) {
                        ...
                        yield office_addin_manifest_1.OfficeAddinManifest.modifyManifestFile(`${path.join(this.destinationPath(), jsonData.getManifestPath(this.project.projectType))}`, 'random', `${this.project.name}`);
                    }
                    else {
    ...
    _postInstallHints() {
        const projFolder = /\s/.test(this.destinationRoot()) ? "\"" + this.destinationRoot() + "\"" : this.destinationRoot();
        let stepNumber = 1;
    ...
    _exitYoOfficeIfProjectFolderExists() {
        if (helperMethods_1.helperMethods.doesProjectFolderExist(this.destinationRoot())) {
